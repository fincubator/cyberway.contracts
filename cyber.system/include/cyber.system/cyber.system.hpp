...
#include <cyber.system/exchange_state.hpp>
...
namespace eosiosystem {
    ...
    */
   struct [[eosio::table("global2"), eosio::contract("cyber.system")]] eosio_global_state2 {
      eosio_global_state2(){}
   ...
   struct [[eosio::table("global3"), eosio::contract("cyber.system")]] eosio_global_state3 {
      eosio_global_state3() { }
   ...
   struct [[eosio::table, eosio::contract("cyber.system")]] producer_info {
      name                  owner;
   ...
   struct [[eosio::table, eosio::contract("cyber.system")]] producer_info2 {
      name            owner;
   ...
   struct [[eosio::table, eosio::contract("cyber.system")]] voter_info {
   ...
   class [[eosio::contract("cyber.system")]] system_contract : public native {
      private:
      ...
      public:
         ...
         /**
          *  Stakes CYBER from the balance of 'from' for the benfit of 'receiver'.
